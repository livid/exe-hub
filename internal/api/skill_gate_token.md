...
hold at least **%s raw base units** of mint `%s`. Holding is checked by
RPC (verdicts cached ~%s); you never sign a Solana transaction — a
signed envelope already proves control of the checked address.
