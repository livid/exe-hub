...
const BTN = "<button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button>"
...
func TestRenderTextFence(t *testing.T) {
	for _, c := range []struct{ in, want string }{
		{"```\ncode\n```", "<div class=\"code first last\"><pre>\ncode</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\n"},
		{"Entry:\n```\ngping 8.8.8.8  terminal gping 8.8.8.8\n```\nafter", "Entry:<div class=\"code\"><pre>\ngping 8.8.8.8  terminal gping 8.8.8.8</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\nafter"},
		{"Entry:\n\n```go\nx\n```\n\nafter", "Entry:<div class=\"code\"><pre>\nx</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\nafter"},
		{"```\n\nblank first\n```", "<div class=\"code first last\"><pre>\n\nblank first</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\n"},
		{"```\n# h\n- i\n**b** `c` [w](https://x.y) https://x.y\n```", "<div class=\"code first last\"><pre>\n# h\n- i\n**b** `c` [w](https://x.y) https://x.y</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\n"},
		{"```\n<b>&amp;\n```", "<div class=\"code first last\"><pre>\n&lt;b&gt;&amp;amp;</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\n"},
		{"```\nopen", "<div class=\"code first last\"><pre>\nopen</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\n"},
		{"```\n```", "<div class=\"code first last\"><pre>\n</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\n"},
		{"the ``` lines\n`a`", "the ``` lines<br>\n<code>a</code>"},
		{"- one\n```\ntwo\n```", "<ul class=\"first\"><li>one</li></ul>\n<div class=\"code last\"><pre>\ntwo</pre><button type=\"button\" class=\"btn copy\"><span>Copy</span><span>Copied</span></button></div>\n"},
