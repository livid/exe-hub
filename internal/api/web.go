...
// webCopyGlyphs is the Copy button's art: a box on another — the
// sheets of a copy — and the check mark it turns into for the moment
// after a press. 13px pixel glyphs as the Hub app's, black outlines in
// currentColor, white faces that a pressed button greys.
